...
package.preload["fennel.binary"] = package.preload["fennel.binary"] or function(...)
  ...
  local _894_ = require("fennel.utils")
  local copy = _894_["copy"]
  local warn = _894_["warn"]
  ...
  local function execute(cmd)
    local _895_0 = os.execute(cmd)
    if (_895_0 == 0) then
      return true
    elseif (_895_0 == true) then
      return true
    end
  end
  ...
  local function module_name(open, rename, used_renames)
    ...
    do
      local _900_0 = rename[open]
      if (nil ~= _900_0) then
        local renamed = _900_0
  ...
  local function fennel__3ec(filename, native, options)
    ...
    local _904_
    do
      _904_ = "(do (local bundle_2_ ...) (fn loader_3_ [name_4_] (match (or (. bundle_2_ name_4_) (. bundle_2_ (.. name_4_ \".init\"))) (mod_5_ ? (= \"function\" (type mod_5_))) mod_5_ (mod_5_ ? (= \"string\" (type mod_5_))) (assert (if (= _VERSION \"Lua 5.1\") (loadstring mod_5_ name_4_) (load mod_5_ name_4_))) nil (values nil (: \"\n\\tmodule '%%s' not found in fennel bundle\" \"format\" name_4_)))) (table.insert (or package.loaders package.searchers) 2 loader_3_) ((assert (loader_3_ \"%s\")) ((or unpack table.unpack) arg)))"
    end
    fennel_loader = _904_:format(dotpath_noextension)
    local lua_loader = fennel["compile-string"](fennel_loader)
    local _905_ = options
    local rename_modules = _905_["rename-modules"]
  ...
  local function compile_binary(lua_c_path, executable_name, static_lua, lua_include_dir, native)
    ...
    local _907_
    do
      local _906_0 = shellout((cc .. " -dumpmachine"))
      if (nil ~= _906_0) then
        _907_ = _906_0:match("mingw")
      else
        _907_ = _906_0
      end
    end
    ...
    compile_command = {cc, "-Os", lua_c_path, table.concat(native, " "), static_lua, rdynamic, "-lm", _910_, "-o", (executable_name .. bin_extension), "-I", lua_include_dir, os.getenv("CC_OPTS")}
  ...
  local function native_path_3f(path)
    ...
    if (version_extension and (version_extension ~= "") and not version_extension:match("%.%d+")) then
      ...
      local _915_0 = extension
      if (_915_0 == "a") then
        return path
      elseif (_915_0 == "o") then
        return path
      elseif (_915_0 == "so") then
        return path
      elseif (_915_0 == "dylib") then
        return path
      else
        local _ = _915_0
        return false
  ...
  local function compile(filename, executable_name, static_lua, lua_include_dir, options, args)
    local _922_ = extract_native_args(args)
    local libraries = _922_["libraries"]
    local modules = _922_["modules"]
    local rename_modules = _922_["rename-modules"]
